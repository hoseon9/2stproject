...
try{
	...
	String sql = "select password,name,role from users where id=?";
...
<table border="1">
	...
	<tr><th>PW</th><td><input type="text" name="password" value="<%=pw%>"></td></tr>
	...
	ADMIN : <input type="radio" name="role" value="Admin"  checked="checked">
	<%} %>
	</td></tr>
	<tr><th>SUBMIT</th><td>
	<input type="submit" value="MODIFY">
	<input type="button" value="수정" onclick="location.href='index.jsp'">	
	</td></tr>
</table>
</form>
</body>
